...
if (!isset($_GET['appid'])) {
    echo 'NO APPLICATION ID FOUND PLEASE GO BACK AND TRY AGAIN';
    session_destroy();
    exit;
}
...
$sql = "UPDATE application SET staff_approval_id = $1, astatus = 'approved', decisiondate = $2 WHERE applicationid = $3;";
