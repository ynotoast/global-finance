...
$sql = "SELECT carid, cname FROM car WHERE carid = $1";
$result = pg_query_params($conn, $sql, array($carid));
if (!$result) {
...
<body id="top" onload="getLocation()">
    ...
    <header class="s-header">
        <div class="row">
            ...
            <nav class="s-header__nav">
                <ul>
                    <li class="current"><a class="smoothscroll" href="#settings">Purchase Car</a></li>
                    <li><a class="smoothscroll" href="#dealerships">Dealerships</a></li>
                    <li><a id="logout" href="account.php">Go To My Account</a></li>
                </ul>
            </nav>
    ...
    <section id="settings" class="s-settings-dark">
        ...
        <div class="row">
            ...
            <div class="column large-12 intro">
                <h1>Buy the
                    <?php echo $carname ?> at one of your nearby dealerships
                </h1>
            </div>
    ...
    <section id="dealership-section" class="s-settings">

        <div class="row">

            <div class="column large-12 intro">

                <h2 style="color: #131516;">Your Closest Dealerships:</h2>
                <div id="dealerships">
                    loading... please enable location services if this section does not load.
                    <ul id="dealerships"></ul>
                </div>
